...
function getDateTime($timeint = null, $diff = 7) {
	...
	if (($years + 1970) % 4 === 0) $leapDays = ($leapYears * 366) - 1;
	...
	*/
	...
	$months = array(1 => 31, $feb, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);//keep it like this!
	$n = 1;
	if ($dsleftover > 31) {
		while ($dsleftover > $months[$n] && $n < 13) {
			$dsleftover -= $months[$n];
